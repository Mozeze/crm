...
<html>
	...
	<body>
		...
		<html:form action="/sysRight" method="post">
			<html:hidden property="o" value="addSysRight" />
			...
			<table class="query_form_table">
				<tr>
					...
					<td>
						<html:text property="sysRight.rightCode"></html:text>
					</td>
					<th>
						权限类型
					</th>
					<td>
						<html:select property="sysRight.rightType">
							...
							<html:option value="Document">子节点</html:option>
						</html:select>
					</td>
					<th>
						父节点
				...
				<tr>
					...
					<td>
						<html:text property="sysRight.rightUrl"></html:text>
					</td>
					<th>权限描述</th>
					<td>
						<html:textarea property="sysRight.rightTip"></html:textarea>
					</td>
				</tr>
			</table>
			<script>
